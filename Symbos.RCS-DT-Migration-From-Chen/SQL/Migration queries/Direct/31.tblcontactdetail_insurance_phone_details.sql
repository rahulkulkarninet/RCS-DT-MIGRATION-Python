INSERT INTO tblContactDetail WITH ( ROWLOCK )
        ...
        FROM
            ...
            INNER JOIN tblContact C WITH ( NOLOCK ) ON CONVERT(nvarchar(200), RCA.Full_Debt_Code) = C.Z_REF
        WHERE
...
UNION ALL
        ...
        FROM
            RC_DRINSURANCE I
            INNER JOIN tblContact C WITH ( NOLOCK ) ON CONVERT(nvarchar(200), I.FullDebtCode) = C.Z_REF
