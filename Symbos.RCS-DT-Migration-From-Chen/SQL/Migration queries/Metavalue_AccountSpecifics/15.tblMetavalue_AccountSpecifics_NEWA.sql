...
INSERT  INTO tblMetaValue_AccountSpecifics WITH ( ROWLOCK )
    ...
    1
    FROM    CTE_NEWAData
            INNER JOIN Metafield_accountspecifics_details Meta on Meta.Name = CTE_NEWAData.Name
            INNER JOIN tblAccount A ON A.AccountNumberPrevious = CONVERT(nvarchar(100), CTE_NEWAData.Full_Debt_Code)
