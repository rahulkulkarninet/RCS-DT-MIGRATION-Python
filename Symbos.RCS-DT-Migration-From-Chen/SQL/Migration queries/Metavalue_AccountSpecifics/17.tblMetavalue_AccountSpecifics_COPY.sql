...
CTE_COPYData AS(
    ...
    CROSS APPLY (VALUES
        ('Requested_Copy_Of_Account', Requested_Copy_Of_Account,NULL,NULL,NULL)
...
INSERT  INTO tblMetaValue_AccountSpecifics WITH ( ROWLOCK )
    ...
    1
    FROM    CTE_COPYData
            INNER JOIN Metafield_accountspecifics_details Meta on Meta.Name = CTE_COPYData.Name
            INNER JOIN tblAccount A ON A.AccountNumberPrevious = CONVERT(nvarchar(100), CTE_COPYData.Full_Debt_Code)
