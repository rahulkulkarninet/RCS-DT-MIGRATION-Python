...
CTE_BILLData AS(
    ...
    CROSS APPLY (VALUES
        ('Billing_Dispute_Issue', Billing_Disput_Issue,NULL,NULL,NULL),
        ('Customer_Contact_Details',Customer_Contact_Details, NULL,NULL,NULL),
        ('Billing_Dispute_Details',Billling_Dispue_Details, NULL,NULL,NULL)
...
INSERT  INTO tblMetaValue_AccountSpecifics WITH ( ROWLOCK )
    ...
    1
    FROM    CTE_BILLData
            INNER JOIN Metafield_accountspecifics_details Meta on Meta.Name = CTE_BILLData.Name
            INNER JOIN tblAccount A ON A.AccountNumberPrevious = CONVERT(nvarchar(100), CTE_BILLData.Full_Debt_Code)
