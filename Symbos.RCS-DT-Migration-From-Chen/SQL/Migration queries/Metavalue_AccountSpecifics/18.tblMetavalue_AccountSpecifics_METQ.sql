...
CTE_METQData AS(
    ...
    CROSS APPLY (VALUES
        ('Details_of_meter_reading', Details_of_meter_reading,NULL,NULL,NULL),
        ('Disputed_Reading',Disputed_Reading, NULL,NULL,NULL),
        ('Estimated_Reading',Estimated_Reading, NULL,NULL,NULL)
...
INSERT  INTO tblMetaValue_AccountSpecifics WITH ( ROWLOCK )
    ...
    1
    FROM    CTE_METQData
            INNER JOIN Metafield_accountspecifics_details Meta on Meta.Name = CTE_METQData.Name
            INNER JOIN tblAccount A ON A.AccountNumberPrevious = CONVERT(nvarchar(100), CTE_METQData.Full_Debt_Code)
