...
CTE_DLOData AS(
    ...
    CROSS APPLY (VALUES
        ('Mail_Returned', Mail_Returned,NULL,NULL,NULL)
...
INSERT  INTO tblMetaValue_AccountSpecifics WITH ( ROWLOCK )
    ...
    1
    FROM    CTE_DLOData
            INNER JOIN Metafield_accountspecifics_details Meta on Meta.Name = CTE_DLOData.Name
            INNER JOIN tblAccount A ON A.AccountNumberPrevious = CONVERT(nvarchar(100), CTE_DLOData.Full_Debt_Code)
