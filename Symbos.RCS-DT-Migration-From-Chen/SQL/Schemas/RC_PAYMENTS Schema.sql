...
CREATE NONCLUSTERED INDEX [IX_RC_PAYMENTS_Debt_Code]
    ON [dbo].[RC_PAYMENTS] ([Debt_Code])
GO
CREATE NONCLUSTERED INDEX [IX_RC_PAYMENTS_Transaction_No]
    ON [dbo].[RC_PAYMENTS] ([Transaction_No])
GO
