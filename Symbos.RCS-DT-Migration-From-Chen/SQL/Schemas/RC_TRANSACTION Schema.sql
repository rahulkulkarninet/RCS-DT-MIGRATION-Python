...
CREATE NONCLUSTERED INDEX [IX_RC_TRANSACTION_Debt_Code]
    ON [dbo].[RC_TRANSACTION] ([Debt_Code])
GO
CREATE NONCLUSTERED INDEX [IX_RC_TRANSACTION_Extended_Debt_Code]
    ON [dbo].[RC_TRANSACTION] ([Extended_Debt_Code])
GO
