...
CREATE NONCLUSTERED INDEX [IX_RC_ARRANGEMENT_Debtor_Code]
    ON [dbo].[RC_ARRANGEMENT] ([Debtor_Code])
GO
CREATE NONCLUSTERED INDEX [IX_RC_ARRANGEMENT_Extended_Debt_Code]
    ON [dbo].[RC_ARRANGEMENT] ([Extended_Debt_Code])
GO
