/*
    tblEntry write cost — the index and change-tracking side of 67.tblentry_notes.
    ...
    0. Why
    ---------------------------------------------------------------------------
    67.tblentry_notes inserts every note in the extract into tblEntry - millions
    ...
    row count (in 67.tblentry_notes) made that work uniform; this script reduces
