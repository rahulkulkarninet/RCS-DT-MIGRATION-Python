...
CREATE NONCLUSTERED INDEX [IX_RC_RELATEDPARTY_Extended_Debt_Code]
    ON [dbo].[RC_RELATEDPARTY] ([Extended_Debt_Code])
GO
CREATE NONCLUSTERED INDEX [IX_RC_RELATEDPARTY_ZID]
    ON [dbo].[RC_RELATEDPARTY] ([ZID])
GO
